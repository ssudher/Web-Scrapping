...
scrapeFile = r"Q:\SVV_A3\Test_Expert\Workspace\CI Data Science\Scraped Data\SQA.Stackexchange.txt"
...
csvfile = open('sqa_person.csv', 'w', newline='', encoding='utf-8')
...
csvfile = open('sqa_tags.csv', 'w', newline='', encoding='utf-8')
