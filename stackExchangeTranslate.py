...
scrapeFile = r"Q:\SVV_A3\Test_Expert\Workspace\CI Data Science\Scraped Data\aviation.stackexchange.com1023_with tags.txt"
...
csvfile = open('aviation_person.csv', 'w', newline='', encoding='utf-8')
...
csvfile = open('aviation_tags.csv', 'w', newline='', encoding='utf-8')
